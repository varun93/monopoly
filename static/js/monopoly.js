...
function updateDice() {
	...
	if (document.images) {
		...
		element0.src = "static/img/Die_" + die0 + ".png";
		element0.alt = die0;
		...
		element1.src = "static/img/Die_" + die1 + ".png";
		element1.alt = die0;
	} else {
		...
		if (sq.owner == turn) {
			...
			if (sq.house >= 1 && sq.house <= 4) {
				for (var x = 1; x <= sq.house; x++) {
					housetext += "<img src='static/img/house.png' alt='' title='House' class='house' />";
				}
			} else if (sq.hotel) {
				housetext += "<img src='static/img/hotel.png' alt='' title='Hotel' class='hotel' />";
			}
...
function updateOption() {
	...
	if (checkedproperty < 0 || checkedproperty >= 40) {
		...
		$("#buildings").show();
		document.getElementById("buildings").innerHTML = "<img src='static/img/house.png' alt='' title='House' class='house' />:&nbsp;" + housesum + "&nbsp;&nbsp;<img src='static/img/hotel.png' alt='' title='Hotel' class='hotel' />:&nbsp;" + hotelsum;
...
function chanceCommunityChest() {
	...
	if (p.position === 2 || p.position === 17 || p.position === 33) {
		...
		popup("<img src='static/img/community_chest_icon.png' style='height: 50px; width: 53px; float: left; margin: 8px 8px 8px 0px;' /><div style='font-weight: bold; font-size: 16px; '>Community Chest:</div><div style='text-align: justify;'>" + communityChestCards[communityChestIndex].text + "</div>", function() {
	...
	// Chance
		...
		popup("<img src='static/img/chance_icon.png' style='height: 50px; width: 26px; float: left; margin: 8px 8px 8px 0px;' /><div style='font-weight: bold; font-size: 16px; '>Chance:</div><div style='text-align: justify;'>" + chanceCards[chanceIndex].text + "</div>", function() {
	...
	for (var x = 1; x <= pcount; x++) {
		...
		for (var i = 0; i < 40; i++) {
			...
			if (sq.owner == x) {
				...
				if (sq.house == 5) {
					housetext += "<span style='float: right; font-weight: bold;'>1&nbsp;x&nbsp;<img src='static/img/hotel.png' alt='' title='Hotel' class='hotel' style='float: none;' /></span>";
				} else if (sq.house > 0 && sq.house < 5) {
					housetext += "<span style='float: right; font-weight: bold;'>" + sq.house + "&nbsp;x&nbsp;<img src='static/img/house.png' alt='' title='House' class='house' style='float: none;' /></span>";
				}
...
window.onload = function() {
	...
	document.getElementById("enlarge0token").innerHTML += '<img src="static/img/arrow_icon.png" height="40" width="136" alt="" />';
	document.getElementById("enlarge20price").innerHTML += "<img src='static/img/free_parking_icon.png' height='80' width='72' alt='' style='position: relative; top: -20px;' />";
	document.getElementById("enlarge38token").innerHTML += '<img src="static/img/tax_icon.png" height="60" width="70" alt="" style="position: relative; top: -20px;" />';
	...
	document.getElementById("enlarge-wrap").innerHTML += "<div id='enlarge40' class='enlarge'><div id='enlarge40color' class='enlarge-color'></div><br /><div id='enlarge40name' class='enlarge-name'>Jail</div><br /><div id='enlarge40price' class='enlarge-price'><img src='static/img/jake_icon.png' height='80' width='80' alt='' style='position: relative; top: -20px;' /></div><br /><div id='enlarge40token' class='enlarge-token'></div></div>";
