...
def testcase_trade(Adjudicator):
	...
	expected_output = {
		"cash": [1500-100-100+200-120-200+50-160+50,1500-140-200-150-50],
		"position":[14,28],
		"properties":[(6,1),(8,2),(9,2),(11,-1),(14,-1),(19,1),(28,-1)]
	}
...
print("a) Purchase of unowned properties")
print("b) A particular Community Card which teleports user to Go")
print("c) Rolling doubles with dice and playing again in the same turn")
print("d) Buying of houses")
print("e) Selling of houses")
